          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="btn95 !px-2 !py-1 text-[10px]"
              ...
              <button
                ...
                className="btn95 !px-2 !py-1 text-[9px] text-slate-600 ml-auto"
              >
                Reset
              </button>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 pt-1 border-t border-slate-100">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={handleCrop}
                className="btn95 is-primary !px-5 !py-2 text-xs font-bold shadow-md"
              >
                ✓ Apply & Save
              </button>
            </div>
